...
_IPEER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='pubkey', full_name='IPeer.pubkey', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='conn', full_name='IPeer.conn', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='first_seen', full_name='IPeer.first_seen', index=2,
