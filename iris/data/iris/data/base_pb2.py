...
_PACKETTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RequestFeeds', index=10, number=10,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ListFeeds', index=11, number=11,
      options=None,
      type=None),
  ],
...
_PACKETBEGINHANDSHAKE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='username', full_name='PacketBeginHandshake.username', index=1,
      number=2, type=9, cpp_type=9, label=2,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PACKETACCEPTHANDSHAKE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='username', full_name='PacketAcceptHandshake.username', index=1,
      number=2, type=9, cpp_type=9, label=2,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PACKETREQUESTFEEDS = _descriptor.Descriptor(
  name='PacketRequestFeeds',
  full_name='PacketRequestFeeds',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='maxsize', full_name='PacketRequestFeeds.maxsize', index=0,
      number=1, type=13, cpp_type=3, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='query', full_name='PacketRequestFeeds.query', index=1,
...
_PACKETLISTFEEDS = _descriptor.Descriptor(
  name='PacketListFeeds',
  full_name='PacketListFeeds',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='feeds', full_name='PacketListFeeds.feeds', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PACKETLISTFEEDS.fields_by_name['feeds'].message_type = _FEED
...
DESCRIPTOR.message_types_by_name['PacketRequestFeeds'] = _PACKETREQUESTFEEDS
DESCRIPTOR.message_types_by_name['PacketListFeeds'] = _PACKETLISTFEEDS
...
class PacketRequestFeeds(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _PACKETREQUESTFEEDS

  # @@protoc_insertion_point(class_scope:PacketRequestFeeds)

class PacketListFeeds(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _PACKETLISTFEEDS

  # @@protoc_insertion_point(class_scope:PacketListFeeds)
